package com.gordon.shop.service;
...
public class RecordService extends Service {
    ...
    private void createEnvironment() {
        mVideoPath = Environment.getExternalStorageDirectory().getPath() + "/RecorderVideo/";
        mMpmngr = ((ShopApplication) getApplication()).getMpmngr();
    ...
    private void setUpMediaProjection() {
        int resultCode = ((ShopApplication) getApplication()).getResultCode();
        Intent data = ((ShopApplication) getApplication()).getResultIntent();
