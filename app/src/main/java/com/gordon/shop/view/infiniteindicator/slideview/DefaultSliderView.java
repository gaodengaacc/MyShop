package com.gordon.shop.view.infiniteindicator.slideview;
...
public class DefaultSliderView extends BaseSliderView{
    ...
    @Override
    public View getView() {
        View v = LayoutInflater.from(getContext()).inflate(R.layout.infiniteindicator_render_type_default,null);
