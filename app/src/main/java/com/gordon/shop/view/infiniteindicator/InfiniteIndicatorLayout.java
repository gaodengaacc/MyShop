...
import com.gordon.shop.view.infiniteindicator.indicator.PageIndicator;
import com.gordon.shop.view.infiniteindicator.indicator.RecyleAdapter;
import com.gordon.shop.view.infiniteindicator.salvage.RecyclingPagerAdapter;
...
//    private boolean isBorderAnimation = true;
    ...
    public InfiniteIndicatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(indicatorType == 0)
            LayoutInflater.from(context).inflate(R.layout.infiniteindicator_layout_default_indicator, this, true);
        else if(indicatorType == 1)
            LayoutInflater.from(context).inflate(R.layout.infiniteindicator_layout_anim_circle_indicator, this, true);
        else
            LayoutInflater.from(context).inflate(R.layout.infiniteindicator_layout_anim_line_indicator, this, true);
