...
public class AnimIndicator extends LinearLayout implements PageIndicator {
	...
	private int mAnimatorResId = R.anim.infiniteindicatore_scale_with_alpha;

	private int mIndicatorBackground = R.drawable.infiniteindicator_white_radius;
	...
	private void handleTypedArray(Context context, AttributeSet attrs) {
		if (attrs != null) {
			...
			mAnimatorResId = typedArray.getResourceId(R.styleable.AnimIndicator_ci_animator,
					R.anim.infiniteindicatore_scale_with_alpha);
			mIndicatorBackground = typedArray.getResourceId(R.styleable.AnimIndicator_ci_drawable,
					R.drawable.infiniteindicator_white_radius);
			typedArray.recycle();
		}
