 ...
 */
package com.gordon.shop.view.infiniteindicator.indicator;
...
public class CircleIndicator extends View implements PageIndicator {
	...
	private  InfiniePositionLisenter lisenter;
	...
	public void  setLisenter  (InfiniePositionLisenter listener){this.lisenter = listener ;}
...
//            longOffset += ((longSize - longPaddingBefore - longPaddingAfter) / 2.0f) - ((mRealCount * threeRadius) / 2.0f);
		...
		for (int iLoop = 0; iLoop < count; iLoop++) {
			...
			//draw bitmap
			if (drawBitmap && pointBitmap != null) {
				canvas.drawBitmap(pointBitmap, dX, dY, new Paint());
			}
...
//        }
		...
		if (drawBitmap) {
			if (pointPreBitmap != null) {
				canvas.drawBitmap(pointPreBitmap, dX, dY, new Paint());
			}
		} else {
	...
	public void onPageSelected(int position) {
		...
		if(lisenter!=null)
			lisenter.changePosition(position);
	}
...
//    }
	...
	boolean drawBitmap = false;

	Bitmap pointBitmap;

	public Bitmap getPointPreBitmap() {
		return pointPreBitmap;
	}

	public void setPointPreBitmap(Bitmap pointPreBitmap) {
		this.pointPreBitmap = pointPreBitmap;
	}

	Bitmap pointPreBitmap;
	...
	public boolean isDrawStrock() {
		return drawStrock;
	}

	public void setDrawStrock(boolean drawStrock) {
		this.drawStrock = drawStrock;
	}

	public interface  InfiniePositionLisenter{
