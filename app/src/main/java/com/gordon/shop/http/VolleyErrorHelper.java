...
public class VolleyErrorHelper {
    ...
    public static String getMessage(Context context, Object error) {
        if (error instanceof TimeoutError) {
            ...
            return context.getResources().getString(R.string.generic_network_unconnected);
        } else if (error instanceof ParseError) {
            return context.getResources().getString(R.string.generic_response_parse_error);
        ...
        if (response != null) {
            switch (response.statusCode) {
                ...
                case 401:
                    ...
                    return msg != null ? msg : context.getResources().getString(R.string.generic_server_down);
